# This Makefile is for the POE::SAPI::HTTP extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/POE/SAPI/HTTP.pm]
#     AUTHOR => q[Paul G Webster <paul@daemonrage.net>]
#     BUILD_REQUIRES => {  }
#     NAME => q[POE::SAPI::HTTP]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/POE/SAPI/HTTP.pm]
...
MAKE = make
FULLEXT = POE/SAPI/HTTP
BASEEXT = HTTP
PARENT_NAME = POE::SAPI
DLBASE = $(BASEEXT)
VERSION_FROM = lib/POE/SAPI/HTTP.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = lib/POE/SAPI/HTTP.pm

PM_TO_BLIB = lib/POE/SAPI/HTTP.pm \
	blib/lib/POE/SAPI/HTTP.pm
...
DISTNAME = POE-SAPI-HTTP
DISTVNAME = POE-SAPI-HTTP-0.03
...
manifypods : pure_all  \
	lib/POE/SAPI/HTTP.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/POE/SAPI/HTTP.pm $(INST_MAN3DIR)/POE::SAPI::HTTP.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               POE-SAPI-HTTP' >> META_new.yml
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/POE/SAPI/HTTP.pm blib/lib/POE/SAPI/HTTP.pm 
